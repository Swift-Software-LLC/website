...
var app = (function () {
    ...
    const file$3 = "src/sections/What-we-do.svelte";
    ...
    const file$2 = "src/sections/Splashscreen.svelte";
    ...
    const file$1 = "src/sections/Money.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$1, 1, 2, 33);
    			attr_dev(h1, "class", "header");
    			add_location(h1, file$1, 3, 4, 92);
    			attr_dev(p0, "class", "svelte-17v1gnr");
    			add_location(p0, file$1, 4, 4, 125);
    			attr_dev(p1, "class", "svelte-17v1gnr");
    			add_location(p1, file$1, 8, 4, 416);
    			attr_dev(p2, "class", "svelte-17v1gnr");
    			add_location(p2, file$1, 12, 4, 654);
    			attr_dev(a, "href", "#contact-us");
    			add_location(a, file$1, 18, 71, 1092);
    			attr_dev(p3, "class", "svelte-17v1gnr");
    			add_location(p3, file$1, 17, 4, 1017);
    			attr_dev(section0, "id", "cost");
    			attr_dev(section0, "class", "svelte-17v1gnr");
    			add_location(section0, file$1, 2, 2, 68);
    			...
    			add_location(img1, file$1, 21, 2, 1197);
    			set_style(section1, "width", "100%");
    ...
    const file = "src/sections/Contact.svelte";
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ WhatWeDo: What_we_do, Splashscreen, Money, Contact });
    	return [];
    }
