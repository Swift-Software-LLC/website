...
var app = (function () {
    ...
    /* src/sections/Cost.svelte generated by Svelte v3.44.3 */

    const file$2 = "src/sections/Cost.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			section0 = element("section");
    			h1 = element("h1");
    			h1.textContent = "Sounds great! But, how much does it cost?";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "It's hard to give a concrete number, as the cost for a MVP depends on many different factors.\n      Larger, more complex projects will logically cost more than simple one page applications.";
    			t3 = space();
    			p1 = element("p");
    			t4 = text("As an estimate, think of around $20,000 per month of development time, for a medium complex MVP.\n      To get a more accurate price estimate, ");
    			a = element("a");
    			a.textContent = "schedule a call";
    			t6 = text(".");
    			t7 = space();
    			p2 = element("p");
    			t8 = text("As we know, many startups, especially those in the pre-seed phase, don't have this kind of capital.\n      This is why we offer ");
    			span = element("span");
    			span.textContent = "part payment in the form of equity";
    			t10 = text(". Think of it as a non-monetary investment into your startup.");
    			attr_dev(h1, "class", "header");
    			add_location(h1, file$2, 2, 4, 94);
    			attr_dev(p0, "class", "svelte-1627iar");
    			add_location(p0, file$2, 3, 4, 164);
    			attr_dev(a, "href", "");
    			attr_dev(a, "onclick", "Calendly.initPopupWidget({url: 'https://calendly.com/swiftsoftware/introduction-call'});return false;");
    			add_location(a, file$2, 9, 45, 529);
    			attr_dev(p1, "class", "svelte-1627iar");
    			add_location(p1, file$2, 7, 4, 377);
    			attr_dev(span, "class", "gradient-text");
    			add_location(span, file$2, 13, 27, 825);
    			attr_dev(p2, "class", "svelte-1627iar");
    			add_location(p2, file$2, 11, 4, 688);
    			attr_dev(section0, "id", "cost");
    			attr_dev(section0, "class", "svelte-1627iar");
    			add_location(section0, file$2, 1, 2, 70);
    			set_style(section1, "width", "100%");
    			set_style(section1, "background-color", "#000");
    			set_style(section1, "color", "#fff");
    			attr_dev(section1, "class", "svelte-1627iar");
    ...
    function instance$3($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Cost', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Cost> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Cost extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1 = element("p");
    			a1 = element("a");
    			a1.textContent = "contact@swiftsoftware.nl";
    			t8 = space();
    			div1 = element("div");
    			p2 = element("p");
    			...
    			t14 = space();
    			p5 = element("p");
    			p5.textContent = "81934580";
    			attr_dev(h1, "class", "header");
    			add_location(h1, file$1, 2, 4, 128);
    			set_style(span, "display", "inline-block");
    			set_style(span, "transform", "rotate(-45deg)");
    			set_style(span, "margin-left", "0.5rem");
    			add_location(span, file$1, 3, 251, 414);
    			attr_dev(a0, "href", "");
    			attr_dev(a0, "class", "button");
    			set_style(a0, "background-color", "#fff");
    			set_style(a0, "color", "#000");
    			set_style(a0, "text-align", "center");
    			set_style(a0, "margin", "0 auto 2rem auto");
    			attr_dev(a0, "onclick", "Calendly.initPopupWidget({url: 'https://calendly.com/swiftsoftware/introduction-call'});return false;");
    			add_location(a0, file$1, 3, 4, 167);
    			attr_dev(p0, "class", "svelte-10ktd6d");
    			add_location(p0, file$1, 6, 8, 597);
    			attr_dev(a1, "href", "mailto:contact@swiftsoftware.nl");
    			add_location(a1, file$1, 7, 11, 622);
    			attr_dev(p1, "class", "svelte-10ktd6d");
    			add_location(p1, file$1, 7, 8, 619);
    			attr_dev(div0, "id", "contact-details__item");
    			attr_dev(div0, "class", "svelte-10ktd6d");
    			add_location(div0, file$1, 5, 6, 556);
    			attr_dev(p2, "class", "svelte-10ktd6d");
    			add_location(p2, file$1, 10, 8, 757);
    			attr_dev(p3, "class", "svelte-10ktd6d");
    			add_location(p3, file$1, 11, 8, 779);
    			attr_dev(div1, "id", "contact-details__item");
    			attr_dev(div1, "class", "svelte-10ktd6d");
    			add_location(div1, file$1, 9, 6, 716);
    			attr_dev(p4, "class", "svelte-10ktd6d");
    			add_location(p4, file$1, 14, 8, 862);
    			attr_dev(p5, "class", "svelte-10ktd6d");
    			add_location(p5, file$1, 15, 8, 882);
    			attr_dev(div2, "id", "contact-details__item");
    			attr_dev(div2, "class", "svelte-10ktd6d");
    			add_location(div2, file$1, 13, 6, 821);
    			attr_dev(div3, "id", "contact-details");
    			add_location(div3, file$1, 4, 4, 523);
    			attr_dev(section0, "id", "contact-us");
    			set_style(section0, "text-align", "center");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "svelte-ko1uw0");
    			add_location(p0, file, 5, 6, 143);
    			attr_dev(p1, "class", "svelte-ko1uw0");
    			add_location(p1, file, 6, 6, 292);
    			attr_dev(div0, "class", "timeline__item svelte-ko1uw0");
    			add_location(div0, file, 3, 4, 82);
    			add_location(h12, file, 9, 6, 420);
    			attr_dev(p2, "class", "svelte-ko1uw0");
    			add_location(p2, file, 10, 6, 458);
    			attr_dev(div1, "class", "timeline__item svelte-ko1uw0");
    			add_location(div1, file, 8, 4, 385);
    			add_location(h13, file, 13, 6, 680);
    			attr_dev(p3, "class", "svelte-ko1uw0");
    			add_location(p3, file, 14, 6, 710);
    			attr_dev(p4, "class", "svelte-ko1uw0");
    			add_location(p4, file, 15, 6, 865);
    			attr_dev(div2, "class", "timeline__item svelte-ko1uw0");
    			add_location(div2, file, 12, 4, 645);
    			add_location(h14, file, 18, 6, 1021);
    			attr_dev(p5, "class", "svelte-ko1uw0");
    			add_location(p5, file, 19, 6, 1048);
    			attr_dev(div3, "class", "timeline__item svelte-ko1uw0");
    			add_location(div3, file, 17, 4, 986);
    			add_location(h15, file, 22, 6, 1286);
    			attr_dev(p6, "class", "svelte-ko1uw0");
    			add_location(p6, file, 23, 6, 1310);
    			attr_dev(div4, "class", "timeline__item svelte-ko1uw0");
    			add_location(div4, file, 21, 4, 1251);
    			attr_dev(div5, "class", "timeline svelte-ko1uw0");
    			add_location(div5, file, 2, 2, 55);
    			attr_dev(section, "class", "svelte-ko1uw0");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(cost.$$.fragment);
    			t4 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(cost, target, anchor);
    		...
    		i: function intro(local) {
    			...
    			transition_in(cost.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(cost.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(cost, detaching);
