    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h10 = element("h1");
    			h10.textContent = "Building";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "We use a modern tech stack to build your MVP as quickly as possible. We know that being first to market can be life or death for a startup.";
    			t3 = space();
    			p1 = element("p");
    			p1.textContent = "We build quickly and efficiently. Without making compromises to expandability and security.";
    			t5 = space();
    			div1 = element("div");
    			h11 = element("h1");
    			h11.textContent = "Rapid Feedback";
    			t7 = space();
    			p2 = element("p");
    			p2.textContent = "We constantly communicate with you to make sure the product is just as you want. We have weekly meetings discussing the progress that has been made.";
    			t9 = space();
    			div2 = element("div");
    			h12 = element("h1");
    			h12.textContent = "Test";
    			t11 = space();
    			p3 = element("p");
    			p3.textContent = "Test";
    			attr_dev(h10, "class", "svelte-1mn3adc");
    			add_location(h10, file$1, 26, 6, 968);
    			attr_dev(p0, "class", "svelte-1mn3adc");
    			add_location(p0, file$1, 27, 6, 992);
    			attr_dev(p1, "class", "svelte-1mn3adc");
    			add_location(p1, file$1, 28, 6, 1145);
    			attr_dev(div0, "class", "grid__item");
    			add_location(div0, file$1, 25, 4, 937);
    			attr_dev(h11, "class", "svelte-1mn3adc");
    			add_location(h11, file$1, 32, 6, 1291);
    			attr_dev(p2, "class", "svelte-1mn3adc");
    			add_location(p2, file$1, 33, 6, 1321);
    			attr_dev(div1, "class", "grid__item");
    			add_location(div1, file$1, 31, 4, 1260);
    			attr_dev(h12, "class", "svelte-1mn3adc");
    			add_location(h12, file$1, 37, 6, 1524);
    			attr_dev(p3, "class", "svelte-1mn3adc");
    			add_location(p3, file$1, 38, 6, 1544);
    			attr_dev(div2, "class", "grid__item");
    			add_location(div2, file$1, 36, 4, 1493);
    			attr_dev(div3, "class", "grid svelte-1mn3adc");
    			add_location(div3, file$1, 24, 2, 914);
    			attr_dev(section, "id", "what-we-do");
    			attr_dev(section, "class", "svelte-1mn3adc");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(" with a minimum viable product your users will ");
    			span1 = element("span");
    			span1.textContent = "love";
    			t6 = space();
    			a = element("a");
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-qanckt");
    			add_location(img, file, 3, 6, 98);
    			attr_dev(div0, "class", "splashscreen_content_image svelte-qanckt");
    			add_location(div0, file, 2, 4, 51);
    			attr_dev(h1, "class", "title svelte-qanckt");
    			add_location(h1, file, 7, 6, 255);
    			attr_dev(span0, "class", "gradient-text");
    			add_location(span0, file, 8, 27, 335);
    			attr_dev(span1, "class", "gradient-text");
    			add_location(span1, file, 8, 120, 428);
    			attr_dev(h2, "class", "subtitle svelte-qanckt");
    			add_location(h2, file, 8, 6, 314);
    			set_style(span2, "display", "inline-block");
    			set_style(span2, "transform", "rotate(90deg)");
    			set_style(span2, "margin-left", "0.5rem");
    			add_location(span2, file, 9, 89, 562);
    			attr_dev(a, "href", "#what-we-do");
    			attr_dev(a, "class", "button");
    			set_style(a, "margin-top", "2rem");
    			add_location(a, file, 9, 6, 479);
    			attr_dev(div1, "class", "splashscreen_content_headings svelte-qanckt");
    			add_location(div1, file, 6, 4, 205);
    			attr_dev(div2, "class", "splashscreen_content svelte-qanckt");
    			add_location(div2, file, 1, 2, 12);
    			attr_dev(section, "class", "svelte-qanckt");
