    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "svelte-t6alyb");
    			add_location(p0, file, 5, 6, 143);
    			attr_dev(p1, "class", "svelte-t6alyb");
    			add_location(p1, file, 6, 6, 292);
    			attr_dev(div0, "class", "timeline__item svelte-t6alyb");
    			add_location(div0, file, 3, 4, 82);
    			add_location(h12, file, 9, 6, 420);
    			attr_dev(p2, "class", "svelte-t6alyb");
    			add_location(p2, file, 10, 6, 458);
    			attr_dev(div1, "class", "timeline__item svelte-t6alyb");
    			add_location(div1, file, 8, 4, 385);
    			add_location(h13, file, 13, 6, 680);
    			attr_dev(p3, "class", "svelte-t6alyb");
    			add_location(p3, file, 14, 6, 710);
    			attr_dev(p4, "class", "svelte-t6alyb");
    			add_location(p4, file, 15, 6, 865);
    			attr_dev(div2, "class", "timeline__item svelte-t6alyb");
    			add_location(div2, file, 12, 4, 645);
    			add_location(h14, file, 18, 6, 1021);
    			attr_dev(p5, "class", "svelte-t6alyb");
    			add_location(p5, file, 19, 6, 1048);
    			attr_dev(div3, "class", "timeline__item svelte-t6alyb");
    			add_location(div3, file, 17, 4, 986);
    			add_location(h15, file, 22, 6, 1286);
    			attr_dev(p6, "class", "svelte-t6alyb");
    			add_location(p6, file, 23, 6, 1310);
    			attr_dev(div4, "class", "timeline__item svelte-t6alyb");
    			add_location(div4, file, 21, 4, 1251);
    			attr_dev(div5, "class", "timeline svelte-t6alyb");
    			add_location(div5, file, 2, 2, 55);
    			attr_dev(section, "class", "svelte-t6alyb");
