...
var app = (function () {
    ...
    const file$2 = "src/sections/What-we-do.svelte";
    ...
    const file$1 = "src/sections/Splashscreen.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 3, 6, 98);
    ...
    const file = "src/sections/Money.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-8rd5pe");
    			add_location(img0, file, 1, 2, 12);
    			attr_dev(h1, "class", "header");
    			add_location(h1, file, 3, 4, 71);
    			attr_dev(p0, "class", "svelte-8rd5pe");
    			add_location(p0, file, 4, 4, 104);
    			attr_dev(p1, "class", "svelte-8rd5pe");
    			add_location(p1, file, 8, 4, 395);
    			attr_dev(p2, "class", "svelte-8rd5pe");
    			add_location(p2, file, 12, 4, 633);
    			attr_dev(a, "href", "#contact-us");
    			add_location(a, file, 18, 71, 1071);
    			attr_dev(p3, "class", "svelte-8rd5pe");
    			add_location(p3, file, 17, 4, 996);
    			attr_dev(section0, "id", "cost");
    			attr_dev(section0, "class", "svelte-8rd5pe");
    			add_location(section0, file, 2, 2, 47);
    			if (!src_url_equal(img1.src, img1_src_value = "/img/chart.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-8rd5pe");
    			add_location(img1, file, 21, 2, 1176);
    			attr_dev(section1, "class", "svelte-8rd5pe");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ WhatWeDo: What_we_do, Splashscreen, Money });
    	return [];
    }
